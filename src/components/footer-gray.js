    ...
    <footer className={`footer-gray-footer ${props.rootClassName} `}>
      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          ...
          <div className="footer-gray-container4">
            ...
            <div className="footer-gray-container7">
              ...
              <span className="footer-gray-text14 large">
                Custom Development
              </span>
              <span className="footer-gray-text15 large">Sponsorships</span>
            </div>
            <div className="footer-gray-container8">
              <span className="footer-gray-text16 large">Legal</span>
              <span className="footer-gray-text17 large">
                Terms &amp; Conditions
              </span>
              <span className="footer-gray-text18 large">Privacy Policy</span>
              <span className="footer-gray-text19 large">Licenses (EULA)</span>
            </div>
          </div>
        </div>
        <span className="footer-gray-text20 small">
          ...
          <span className="footer-gray-text22">Creative Tim</span>
          <span className="">.</span>
        </span>
      </div>
    </footer>
